...
import type {
  PCOLicenseDiamond,
  PCOLicenseDiamondInterface,
} from "../PCOLicenseDiamond";
...
export class PCOLicenseDiamond__factory {
  ...
  static createInterface(): PCOLicenseDiamondInterface {
    return new utils.Interface(_abi) as PCOLicenseDiamondInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PCOLicenseDiamond {
    return new Contract(address, _abi, signerOrProvider) as PCOLicenseDiamond;
  }
}
