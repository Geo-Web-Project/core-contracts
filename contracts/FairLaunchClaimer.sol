...
contract FairLaunchClaimer is Pausable, AccessControl, IClaimer {
     ...
     */
    function setParcel(address _parcelAddress) external onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     * @custom:requires DEFAULT_ADMIN_ROLE
     */
    function setLicense(address _licenseAddress) external onlyRole(DEFAULT_ADMIN_ROLE) {
